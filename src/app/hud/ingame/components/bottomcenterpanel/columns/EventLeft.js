      ...
      >
        ...
        <img
          className={`
            ...
            transition-all duration-500
            ${isDead ? "grayscale opacity-30 scale-110" : "grayscale-0 opacity-100 scale-100"}
          `}
      ...
      >
        ...
        {ulti && ulti.level > 0 ? (
          <img
            ...
            className={`w-full h-full object-cover rounded-full transition-all duration-300 ${isUltiOnCooldown ? "grayscale brightness-[0.55]" : "brightness-100"}`}
            alt="ultimate"
          />
        ) : (
