...
const L1 = () => {
  ...
  const renderPlayerContent = (i) => {
    ...
    return (
          ...
          {finalDisplay.map((slot, index) => (
            <motion.div
              ...
              className={`
                ...
                ${isDead ? "border-zinc-800" : "border-zinc-700"}
              `}
            >
              {slot.item ? (
                <>
      ...
      rounded-[2px]
      flex items-center justify-center
      ${isDead ? "bg-zinc-900 border-white/5" : "bg-zinc-800 border-white/5"}
    `}
          >
      ...
      w-[17px] h-[17px]
      flex items-center justify-center
      ${isDead ? "bg-zinc-900 border-zinc-800" : "bg-zinc-800 border-white/5"}
    `}
          >
