    ...
    return (
      <div className={`flex items-center w-full h-full px-1 justify-between transition-all duration-500 ${isDead ? "grayscale opacity-60" : "opacity-100"}`}>
                ...
                <>
                  ...
                  {slot.isTrinket && (
                    <>
                      ...
                      <div className={`absolute inset-0 bg-zinc-950/10 border pointer-events-none ${isDead ? "border-zinc-500/20" : "border-yellow-500/20"}`} />
                    </>
                  )}
                </>
              ) : null}
        ...
        <div className="flex flex-col gap-[4px]">
          ...
          <div className={`size-[17px] rounded-[2px] flex items-center justify-center ${isDead}`}>
          ...
          <div className={`size-[17px] flex items-center justify-center ${isDead}`}>
